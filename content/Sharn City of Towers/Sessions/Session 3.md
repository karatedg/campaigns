...
We reach it and the sign is dangling from a single. As we look around, the windows are covered by curtains, but we see one of the curtains shifts as we approach. The front door is locked, but there is a back door that is also locked.

We knock on the back door and they don't let us in, so Paulie goes around to the front to knock as well.

With some intimidation, Paulie gets us inside the place to acquire some accoutrements. 
